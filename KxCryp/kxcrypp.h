...
KXCRYPAPI SECURITY_STATUS SEC_ENTRY Ext_AcquireCredentialsHandleW(
	...
	IN	PVOID			GetKeyArgument OPTIONAL,
	OUT	PCredHandle		CredentialHandle,
	OUT	PTimeStamp		Expiry OPTIONAL);KXCRYPAPI NTSTATUS WINAPI Ext_BCryptDeriveKeyPBKDF2(IN BCRYPT_ALG_HANDLE Algorithm, IN PUCHAR Password, IN ULONG PasswordCb, IN PUCHAR Salt OPTIONAL, IN ULONG SaltCb, IN ULONGLONG IterationCount, OUT PUCHAR DerivedKey, IN ULONG DerivedKeyCb, IN ULONG Flags);
