...
BOOLEAN InjectStringToConsoleInput(
	IN	HANDLE	ConsoleHandle,
	IN	PCWSTR	String);
DWORD WINAPI Ext_GetActiveProcessorCount(IN WORD GroupNumber);
WORD WINAPI Ext_GetActiveProcessorGroupCount(VOID);
DWORD WINAPI Ext_GetMaximumProcessorCount(IN WORD GroupNumber);
WORD WINAPI Ext_GetMaximumProcessorGroupCount(VOID);
