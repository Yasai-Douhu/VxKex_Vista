...
// GetThreadGroupAffinity is implemented for Vista in misc.c.
...
#pragma comment(linker, "/EXPORT:K32GetModuleBaseNameA=psapi.GetModuleBaseNameA")
#pragma comment(linker, "/EXPORT:K32GetModuleBaseNameW=psapi.GetModuleBaseNameW")
#pragma comment(linker, "/EXPORT:K32GetModuleFileNameExA=kernel32.K32GetModuleFileNameExA")
#pragma comment(linker, "/EXPORT:K32GetModuleFileNameExW=psapi.GetModuleFileNameExW")
#pragma comment(linker, "/EXPORT:K32GetModuleInformation=psapi.GetModuleInformation")
#pragma comment(linker, "/EXPORT:K32GetPerformanceInfo=psapi.GetPerformanceInfo")
...
#pragma comment(linker, "/EXPORT:K32QueryWorkingSetEx=psapi.QueryWorkingSetEx")
...
// PowerClearRequest is implemented for Vista in misc.c.
// PowerCreateRequest is implemented for Vista in misc.c.
// PowerSetRequest is implemented for Vista in misc.c.
...
// RaiseFailFastException is implemented for Vista in misc.c.
...
// ResolveLocaleName is implemented for Vista in misc.c.
...
// TryAcquireSRWLockExclusive と TryAcquireSRWLockShared は
// Vista の kernel32/ntdll に存在しないため synch.c に直接実装した。
// フォワードエントリは KxBase.def で定義されている。
