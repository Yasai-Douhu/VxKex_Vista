// Native Vista exports imported by kernel32, absent from the Win7 list.
#pragma comment(linker, "/EXPORT:LdrpResGetRCConfig=ntdll.LdrpResGetRCConfig")
#pragma comment(linker, "/EXPORT:NtRequestWakeupLatency=ntdll.NtRequestWakeupLatency")
#pragma comment(linker, "/EXPORT:NtRequestDeviceWakeup=ntdll.NtRequestDeviceWakeup")
#pragma comment(linker, "/EXPORT:NtCancelDeviceWakeupRequest=ntdll.NtCancelDeviceWakeupRequest")
#pragma comment(linker, "/EXPORT:WerReportWatsonEvent=ntdll.WerReportWatsonEvent")
#pragma comment(linker, "/EXPORT:WerCheckEventEscalation=ntdll.WerCheckEventEscalation")
#ifdef _M_X64
